...
class Dataset_Solar(Dataset):
    def __init__(self, root_path, flag='train', size=None, data_path='ETTh1.csv',
                 seasonal_patterns=None, drop_short=False,nonautoregressive=False, test_flag='T', subset_rand_ratio=1.0):
...
class Dataset_M4(Dataset):
    def __init__(self, root_path, flag='pred', size=None, data_path='ETTh1.csv',
                 scale=False, inverse=False, seasonal_patterns=None, drop_short=False,nonautoregressive=False, test_flag='T', subset_rand_ratio=1.0):
        self.scale = scale
